pipeline {
   ...
   stages {
      ...
      stage ('Build') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'build of ColorMatch failed', body: 'build of ColorMatch failed'
              }
          }
      }
      ...
      stage ('Deploy') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'deploy of ColorMatch failed', body: 'deploy of ColorMatch failed'
              }
          }
      }
   }
